 ...
 * @version v1.0
 */
public class MyTest16_4 extends ClassLoader {
    /** 自定义类加载器的名字 */
    ...
    public MyTest16_4(String classLoaderName) {
        super();// 将系 统类加载器当做该类加载器的父加载器
        this.classLoaderName = classLoaderName;
    }

    public MyTest16_4(ClassLoader parent, String classLoaderName) {
    ...
    public static void main(String[] args) throws Exception {
        ...
        MyTest16_4 loader1 = new MyTest16_4("loader1");
        test(loader1);
    }
}
